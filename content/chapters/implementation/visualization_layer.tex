...
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{images/implementation/grafana_cells.png}
  \caption{Dashboard Grafana tratte dal sistema di telemetria di SquadraCorse in cui si visualizzano le temperature e le tensioni delle celle di un modulo della batteria}
  \label{fig:grafana-cells}
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{images/implementation/grafana_pressure.png}
  \caption{Dashboard Grafana tratte dal sistema di telemetria di SquadraCorse in cui si visualizza l'andamento delle pressioni}
  \label{fig:grafana-pressure}
\end{figure}

\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{images/implementation/grafana_fsm.png}
  \caption{Dashboard Grafana tratte dal sistema di telemetria di SquadraCorse in cui si visualizza l'andamento di una FSM}
