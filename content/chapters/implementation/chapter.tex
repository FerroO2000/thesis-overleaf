...
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\textwidth]{images/implementation/architecture.png}
  \caption{Schema dell'architettura del sistema di telemetria}
  \label{fig:telemetry-architecture}
\end{figure}

\include{content/chapters/implementation/ingestion_layer}
\include{content/chapters/implementation/processing_layer}
\include{content/chapters/implementation/storage_layer}
\include{content/chapters/implementation/observability_layer}
\include{content/chapters/implementation/visualization_layer}